namespace TumbangPreso.Core
{
    ...
    public static class TournamentPreset
    {
        ...
        {
            new Modifier("WorldGraphicsProbe.Active",
                "A scripted rendering benchmark that parks players. Never a bracket match."),
        ...
        public static readonly Modifier[] NotModifiers =
        {
            ...
            new Modifier("-tp-catchseat",
                "Diagnostic argument for NetCatchPresentationProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-catchtrace",
                "Diagnostic argument for NetCatchPresentationProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-dantecase",
                "Diagnostic argument for NetDanteProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-dantepending-review",
                "Diagnostic argument for NetDanteProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-dantetrace",
                "Diagnostic argument for NetDanteProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-field-rejoin",
                "Diagnostic argument for NetWorldFieldProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-field-rejoin-port",
                "Diagnostic argument for NetWorldFieldProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-gameplay-review-only",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-halftime-only",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-hero-replays",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-holdcharge",
                "Diagnostic argument for NetSeanProbe, NetZackProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-icecase",
                "Diagnostic argument for NetIceProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-icetrace",
                "Diagnostic argument for NetIceProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-introduction-bodies-only",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-introduction-scenes",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-live-ultimates-only",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-map-surfaces-only",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-menu-review-only",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-momentmode",
                "Diagnostic argument for NetMomentProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-momentseat",
                "Diagnostic argument for NetMomentProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-momenttrace",
                "Diagnostic argument for NetMomentProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-movement-review",
                "Diagnostic argument for NetDanteProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-movementlate-review",
                "Diagnostic argument for NetDanteProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-ordinary-skills",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-pendinghero",
                "Diagnostic argument for NetDanteProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-pendinglate-review",
                "Diagnostic argument for NetDanteProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-personalcase",
                "Diagnostic argument for NetPersonalBuffProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-personaltrace",
                "Diagnostic argument for NetPersonalBuffProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-phaister-observe-existing",
                "Diagnostic argument for NetPhaisterProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-phaistercase",
                "Diagnostic argument for NetPhaisterProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-phaistertrace",
                "Diagnostic argument for NetPhaisterProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-predictionseat",
                "Diagnostic argument for NetPredictionReceiptProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-predictiontrace",
                "Diagnostic argument for NetPredictionReceiptProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-rafitrace",
                "Diagnostic argument for NetRafiProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-recall-mode",
                "Diagnostic argument for NetRecallRenderProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-recall-render",
                "Diagnostic argument for NetRecallRenderProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-recall-seat",
                "Diagnostic argument for NetRecallRenderProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-recovery-review-only",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-refresh-seat",
                "Diagnostic argument for NetDanteProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-rehost-old-epoch",
                "Diagnostic argument for NetRequestSafetyProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-rehost-phase",
                "Diagnostic argument for NetRequestSafetyProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-replay-fault",
                "Diagnostic argument for NetReplayProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-replay-ready-peers",
                "Diagnostic argument for NetReplayProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-replaymode",
                "Diagnostic argument for NetReplayProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-replayseat",
                "Diagnostic argument for NetReplayProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-replaytrace",
                "Diagnostic argument for NetReplayProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-requestsafety",
                "Diagnostic argument for NetRequestSafetyProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-requestsafety-kill",
                "Diagnostic argument for NetRequestSafetyProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-requestsafety-leave",
                "Diagnostic argument for NetRequestSafetyProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-requestsafety-matches",
                "Diagnostic argument for NetRequestSafetyProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-requestsafety-rehost",
                "Diagnostic argument for NetRequestSafetyProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-requestsafety-rejoin",
                "Diagnostic argument for NetRequestSafetyProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-result-end",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-review-caster-roster",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-review-frame-poll",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-review-hero",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-review-low-comfort",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-review-map",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-review-mode",
            ...
            new Modifier("-tp-round-rejoin-port",
                "Diagnostic argument for NetRoundBoundaryProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-roundtrace",
                "Diagnostic argument for NetRoundBoundaryProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-sean-observe-existing",
                "Diagnostic argument for NetSeanProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-sean-visual-review-only",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-seancase",
                "Diagnostic argument for NetSeanProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-seantrace",
                "Diagnostic argument for NetSeanProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-skill-variants",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            ...
            new Modifier("-tp-ult-disconnect",
                "Diagnostic argument for NetUltimatePhaseProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-ult-latejoin",
                "Diagnostic argument for NetUltimatePhaseProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-ultseat",
                "Diagnostic argument for NetUltimatePhaseProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-ulttrace",
                "Diagnostic argument for NetUltimatePhaseProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-variant-observer",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-whole-matches",
                "Diagnostic argument for OwnerUiPlayerReview. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-worldfieldtrace",
                "Diagnostic argument for NetWorldFieldProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-zack-observe-existing",
                "Diagnostic argument for NetZackProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-zackcase",
                "Diagnostic argument for NetZackProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
            new Modifier("-tp-zacktrace",
                "Diagnostic argument for NetZackProbe. Its installer/configuration is disabled by -tp-tournament; it is not a saved player preference."),
        ...
        public static string LaunchSwitchModifier(string switchName)
        {
            switch (switchName)
            {
                ...
                case "-tp-graphicsreport": return "WorldGraphicsProbe.Active";
