...
| [`Asset_Sourcing.md`](Asset_Sourcing.md) | **The verified zero-cost source list for the Hero Strike VFX and SFX replacement pass.** Maps every one of the eighteen abilities to specific CC0 art, lists recorded CC0 sound sources, records public-repository licence limits, and keeps later building/map candidates without touching the existing characters. |
