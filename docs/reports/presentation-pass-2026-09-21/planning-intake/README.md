...
[map-checkpoint.md](../../improvement-2026-09-10/map-checkpoint.md).
The new continuation's isolated flight correction and saved-authoring verification
are in [map-retrieval.md](../../improvement-2026-09-12/map-retrieval.md) and
...
| [`CLAUDE_ENGINEERING_LANE.md`](../../../CLAUDE_ENGINEERING_LANE.md) | Exclusive separate-PC engineering reservation: three AI/retrieval/lookup tasks, file boundaries, completion evidence, safe shared-branch integration and its own execution log. Codex leaves this lane alone. |
| [`CLAUDE_REQUEST_SAFETY_LANE.md`](../../../CLAUDE_REQUEST_SAFETY_LANE.md) | Additional manual separate-PC C4 assignment: remaining149.4 request/reply safety, protected networking files, verification and honest completion. |
| [`reports/pending-casts-2026-09-15/README.md`](../../pending-casts-2026-09-15/README.md) | Initial pending-cast correction, failed baseline/fixture distinctions, scoped body/FPP/native evidence and remaining validation. |
| [`reports/fpp-shadow-version-2026-09-15/README.md`](../../fpp-shadow-version-2026-09-15/README.md) | Urgent first-person slipper shadow correction, plain/charged regression and central removal of visible game version labels. |
| [`reports/movement-joining-2026-09-15/README.md`](../../movement-joining-2026-09-15/README.md) | Remaining Sean Rush/Zack Sprint state, emitter ownership and scoped baseline/regression/native evidence. |
| [`reports/claude-engineering-2026-09-15/README.md`](../../claude-engineering-2026-09-15/README.md) | The separate worker's published AI retrieval/lunge and lookup measurements, with historical-reproduction and platform limits. Their reservation remains separately owned. |
