...
<!-- LIVE_STATE_START -->
**Live now,2026-09-13:** Pushed50e07025;motion/protocol29/handover DIRTY. Player44957 ACTIVE:Classic strictcase,Logs/throw-network-classic-v4.
Hero150ms/rejoin60712 PASSED strict setup:foreignshoe0 pickup/disarm observed,
all3 signedphases match,159rejoined active samples,0ghostheld on allpeers.
RuntimeSHA307167a3a54ebb1f9ec44db7799bd14cad46321cf98b906c76b2fbf60bf2189c;26profilesrestored.
Runtime/assets frozen;noEditoractive. BuildV5 succeeded,profile66105cb04fbf
restored25files. Deterministic ordinary-input warmup now in that executable. Corrected buildV4 Hero150ms/rejoin had matching stages/release,0ghost
samples,158active rejoin samples BUT strict regression setup did not occur (AI
picked itsownshoe1). Treat as setup-not-covered,not the required regression pass.
New NetThrowProbe warmup deterministically disables other drivers and uses ordinary
Move+Grab to acquire shoe0 before the owner connects,then clears that fixtureinput
at whistle. No forced equip or production rule bypass. BuildV5 running,then strict
Hero150ms/rejoin and Classic cases. Log/evaluator --require-warmup-swap must show
actualforeignpickup AND disarm beforewhistle. Buildhelper50e07025 is pushed/2tests
pass. Handovercorrectedruntime504Edit,4physicalflight/retrieval,8checks/14audits pass;
corrected3process causalcase stilldue. Preserve all failures and broader fullscope.
<!-- LIVE_STATE_END -->
