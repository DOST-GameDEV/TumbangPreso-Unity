# UI queue removed by owner,2026-09-14

The owner asked to remove UI from the to-do list. The following is an INACTIVE
archive, not work to resume. Existing UI, artwork, source and pending patch remain
preserved. Do not reactivate this queue without a new owner request.
