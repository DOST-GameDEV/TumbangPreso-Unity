...
903e17220veranda/screen unit PUBLISHED/remote verified; QUAL exact candidate
stashed/advanced903e17220. No active Unity. Next metal-roof unit planned in
lagoon-metal-plan.md: match shader ribs to physical slope/pitch on1/2/7/9/13/15,
and a restrained painted lower wall only onhouse2from the viewed Embassy reference.
Preserve geometry/other palettes/collision. No metal code/assets changed yet.

Metal candidate copied to QUAL. Author runs Logs/refine2-lagoon-metal-v1/author.log:
six metal-roof UV/material fits to actual rib pitch/direction; house2only gets a
painted lower wall band and long-axis single-board grain. No new geometry/global
shader edits. Topology/other coordinates/material slots/collision guarded. Freeze.cs.
After author, one paused native front2/roof2/repair1comparison and grey inspection.

Metal author63204completed/reaped: six actual rib pitches/directions fitted,
house2painted band only, source topology/non-target slots/collision unchanged.
Full patch saved/known profile and PNGmeta churn restored. Current paired native
case runs Logs/refine2-lagoon-metal-v1/check.log/results.xml. Freeze.cs. Judge actual
front/roof2/repair1images before keeping the paint/material result.
