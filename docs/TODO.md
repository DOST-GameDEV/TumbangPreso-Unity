...
## 24 · Kuro's projected body deleted itself mid-ability, and took Nemu's way home with it
...
### 24.1 Two clocks that nothing kept in step
...
### 24.2 And the faster path was worse
...
### 24.3 The fix, in the shape the repo already uses for this
...
## 25 · Seat 0 travels about half what seats 1 to 3 do, in Classic, every run

**Found on 2026-08-27 while verifying § 24, not looked for.** `BotBehaviourProbe`'s
...
⚠️ **Not caused by § 23 or § 24.** Both are Hero Strike and HUD work; this is Classic, which
has no kits (`kits seen False` in the same report) and does not draw an ability deck. Two full
PlayMode runs with § 23 alone were green, which is consistent with an intermittent that predates
both.
