...
5. **`ServerQuery.cs` (234 lines):** Replaced the retired legacy VPS pool unicast with UGS Lobby
   query while preserving LAN-first join code resolution. The Unity game has no Vultr endpoint.
