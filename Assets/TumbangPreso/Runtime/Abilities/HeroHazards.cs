...
namespace TumbangPreso.Abilities
{
    ...
    public static class HeroHazards
    {
                                                ...
                                                float effectScale = 1.0f)
        {
            ...
            // The owner rejected the raised hexagonal platform, five spikes and
            // central upright cutout. A slipping zone must read as frozen street,
            ...
            comp.ChillMultiplier = Mathf.Clamp(1.0f - ((1.0f - 0.55f) * effectScale), 0.25f, 0.95f);
