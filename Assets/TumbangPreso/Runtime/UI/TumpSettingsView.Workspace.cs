...
namespace TumbangPreso.UI
{
    public sealed partial class TumpSettingsView
    {
        private void Build(Transform owner)
        {
            ...
            OwnerUiLayout.Fill(background.rectTransform); background.color = new Color32(234, 216, 187, 255); background.raycastTarget = false;
            ...
            panel.color = new Color32(245, 234, 215, 255); panel.raycastTarget = false;
            ...
            OwnerUiLayout.Place(title.rectTransform, 80, 130, 410, 130);
            for (int i = 0; i < Sections.Length; i++)
            {
                ...
                OwnerUiLayout.Place(mark.rectTransform, 18, 75, 286, 5); mark.color = OwnerUiTheme.Current.Green; mark.raycastTarget = false;
                _tabs.Add(tab);
            }
            var note = OwnerUiLayout.Text(root, "SaveHint", "Save your changes\nwhen you're ready.", 28);
            OwnerUiLayout.Place(note.rectTransform, 86, 951, 381, 91); note.color = OwnerUiTheme.Current.EnteredInk;
            _heading = OwnerUiLayout.Text(root, "Heading", "", 62, OwnerUiLayout.TypeRole.Display);
            OwnerUiLayout.Place(_heading.rectTransform, 572, 104, 1238, 113);
            ...
            OwnerUiLayout.Place(_status.rectTransform, 578, 913, 737, 115); _status.color = OwnerUiTheme.Current.EnteredInk;
