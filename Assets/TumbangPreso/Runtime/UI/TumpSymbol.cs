...
namespace TumbangPreso.UI
{
    ...
    {
        public enum Icon { Back, Check, Close, Settings, Audio, Controller, Keyboard, Eye, Person, Exit, Book, Info, Bots, Friends, Trophy, Can }
        public Icon Kind;
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            switch (Kind)
            {
                ...
                case Icon.Can:Ring(vh,0,.27f,.27f,.09f);P(vh,-.27f,.27f,-.24f,-.29f,-.10f,-.36f,.16f,-.34f,.27f,-.27f,.27f,.27f);P(vh,-.25f,-.09f,.26f,-.09f);P(vh,-.25f,.03f,.27f,.03f);break;
