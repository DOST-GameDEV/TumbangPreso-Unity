...
namespace TumbangPreso.UI
{
    public sealed class SettingsOptionMenu : MonoBehaviour
    {
        ...
        public static SettingsOptionMenu Create(Transform parent,string name,string[] values,int selected,Action<int> choose)
        {
            ...
            OwnerUiLayout.Place(frame.rectTransform,0,0,533,78); frame.color=new Color32(227,208,179,255);
        ...
        private void Open()
        {
            ...
            var paper=box.gameObject.AddComponent<Image>();paper.color=new Color32(240,226,202,255);paper.raycastTarget=true;
            ...
            for(int i=0;i<_options.Length;i++)
            {
                ...
                var colours=button.colors; colours.normalColor=i==_selected?OwnerUiTheme.Current.Green:OwnerUiTheme.Current.ActionInk; button.colors=colours;
