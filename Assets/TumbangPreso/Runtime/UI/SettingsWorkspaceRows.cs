...
namespace TumbangPreso.UI
{
    ...
    public static class SettingsWorkspaceRows
    {
        public static RectTransform Row(Transform parent, string name, string label)
        {
            ...
            OwnerUiLayout.Place(text.rectTransform, 3, 9, 585, 78); text.color = OwnerUiTheme.Current.EnteredInk;
            ...
            line.color = new Color32(177, 144, 106, 75); line.raycastTarget = false;
        ...
        public static void Toggle(Transform parent, string name, bool current, Action<bool> changed)
        {
            ...
            OwnerUiLayout.Place(text.rectTransform, 134, 4, 350, 68); toggle.SetIsOnWithoutNotify(current);
        ...
        public static Slider Slider(Transform parent, string name, float value, float minimum, float maximum, Action<float> changed, Func<float, string> show)
        {
            ...
            OwnerUiLayout.Place(track.rectTransform, 17, 33, 360, 10); track.color = new Color32(210, 178, 133, 255); track.raycastTarget = false;
            var fill = OwnerUiLayout.Rect(track.transform, "Fill").gameObject.AddComponent<Image>();
            OwnerUiLayout.Fill(fill.rectTransform); fill.color = OwnerUiTheme.Current.Green; fill.raycastTarget = false; slider.fillRect = fill.rectTransform;
            ...
            OwnerUiLayout.Place(text.rectTransform, 406, 4, 120, 68); text.alignment = TextAnchor.MiddleCenter;
        ...
        public static InputField Entry(Transform parent, string name, string placeholder)
        {
            ...
            OwnerUiLayout.Place(root.rectTransform, 0, 0, 533, 78); root.color = new Color32(227, 208, 179, 255);
            var field = root.gameObject.AddComponent<InputField>(); field.targetGraphic = root; field.lineType = InputField.LineType.SingleLine;
            var typed = OwnerUiLayout.Text(root.transform, "EnteredText", "", 31); typed.color = OwnerUiTheme.Current.EnteredInk;
            ...
            var hint = OwnerUiLayout.Text(root.transform, "Placeholder", placeholder, 28); hint.color = OwnerUiTheme.Current.ActionInk;
        ...
        public static Button Action(Transform parent, string name, string words, System.Action action, float width = 533)
        {
            ...
            var colours = button.colors; colours.normalColor = OwnerUiTheme.Current.ActionInk;
            colours.highlightedColor = colours.selectedColor = OwnerUiTheme.Current.Green;
            colours.disabledColor = new Color32(143, 124, 109, 255); colours.pressedColor = OwnerUiTheme.Current.DeepInk;
