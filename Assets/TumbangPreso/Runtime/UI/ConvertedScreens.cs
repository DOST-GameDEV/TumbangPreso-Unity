...
namespace TumbangPreso.UI
{
    ...
    /// <summary>Ported from `main_menu.gd`.</summary>
    public sealed class ConvertedMainMenu : ConvertedScreen
    {
        protected override void Wire()
        {
            OnClick("StartButton", () => SceneFlow.Go(SceneFlow.ModeSelect));
            OnClick("SettingsButton", () => Panel.Open<SettingsPanel>(this));
            OnClick("TutorialButton", () => Panel.Open<TutorialPanel>(this));
            OnClick("CreditsButton", () => Panel.Open<CreditsPanel>(this));
