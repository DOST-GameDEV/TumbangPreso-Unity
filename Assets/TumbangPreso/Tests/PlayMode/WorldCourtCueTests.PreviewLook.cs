...
namespace TumbangPreso.PlayTests
{
    public sealed partial class WorldCourtCueTests
    {
        ...
        // The same pick as MapPreviewSurface.ApplyWorldLook: the first shadow-casting directional
        ...
        private static void SavePreview(Camera camera,string name)
        {
            var target=camera.targetTexture;camera.Render();
